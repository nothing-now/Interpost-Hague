#define DEFAULT_HUNGER_FACTOR 0.50 // Factor of how fast mob nutrition decreases
#define DEFAULT_THIRST_FACTOR 0.30 // Factor of how fast mob hydration decreases
