...
/decl/communication_channel/pray/do_communicate(var/mob/communicator, var/message, var/speech_method_type)
	...
	for(var/m in GLOB.player_list)
		...
		if(M.client.holder && M.client.get_preference_value(/datum/client_preference/staff/show_chat_prayers) == GLOB.PREF_SHOW)
			receive_communication(communicator, M, "\[<A HREF='?_src_=holder;adminplayeropts=\ref[Sender]'>PP</A>] [<A HREF='?_src_=vars;Vars=\ref[Sender]'>VV</A>] [<A HREF='?_src_=holder;subtlemessage=\ref[Sender]'>SM</A>] [[admin_jump_link(Sender, src)]] [<A HREF='?_src_=holder;secretsadmin=check_antagonist'>CA</A>] [<A HREF='?_src_=holder;BlueSpaceArtillery=\ref[Sender]'>BSA</A>] [<A HREF='?_src_=holder;CentcommReply=\ref[Sender]'>RPLY</A>]<span class='notice'>\icon[cross] <b><font color=purple>PRAY: </font>[key_name(communicator, 1)]: </b>[message]</span>")
