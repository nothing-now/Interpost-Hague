...
/mob
	...
	var/skills = list("melee" = 40, "ranged" = 40, "medical" = 40, "surgery" = 40, "engineering" = 40, "crafting" = 40, "cooking" = 40, "science" = 40, "cleaning" = 40, "gardening" = 40, "mining" = 40)
...
/mob/living/carbon/human/verb/check_skills()//Debug tool for checking skills until I add the icon for it to the HUD.
	...
	message += "I am <b>[skillnumtodesc(skills["gardening"])]</b> at gardening.</b></i>\n"
	message += "I am <b>[skillnumtodesc(skills["mining"])]</b> at mining.</b></i>\n"
	to_chat(src, message)
