...
/obj/machinery/media/jukebox/proc/StartPlaying()
	...
	sound_token = GLOB.sound_player.PlayLoopingSound(src, sound_id, current_track.sound, volume = volume, range = 14, falloff = 3, prefer_mute = TRUE, ignore_vis = FALSE, streaming = TRUE)
	playing = 1
	update_use_power(2)
	update_icon()
